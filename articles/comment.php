...
?>
                <form style="z-index:5; position:relative;" action="<?php echo "main.php?id=".$id."&page=".$page."#cmt_frame" ?>" method="POST">
                        ...
                        <button style="margin:5px;padding:10px;font-size:medium; border-radius: 5% ;background-color: #00748b; color:white;" type="sumbit"><p id="choose_best"><?php 
...
<?php
                    ...
                    if($item['best_cmt'] == 1){
?>
                <li><p id="best_soluton" style="padding:10px;font-size:medium; border-radius: 5% ;background-color: #00748b; color:white;">BEST SOLUTION</p></li>
<?php
