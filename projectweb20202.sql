...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th5 22, 2021 lúc 05:55 PM
...
INSERT INTO `account_infor` (`account`, `date`, `level`, `numberofpost`, `numberofheart`, `password`, `verification_code`, `verified`) VALUES
('haik63', '2021-05-22', 0, 0, 0, 'notadmin', '', 1),
('haiphamk63', '2021-04-11', 1, 5, 80, 'admin', '', 1),
('hatq', '2021-04-11', 1, 9, 0, 'admin', '', 1),
('tranha31', '2021-05-19', 0, 3, 0, '12345678b', '96d412c9040fa129945ed3046fa9fa3e', 1),
('tronghaiit2', '2021-04-08', 1, 10, 100, 'admin', '', 1);
...
(4, 'tronghaiit2', 'What does “use strict” do in JavaScript, and what is the reasoning behind it?', 'Recently, I ran some of my JavaScript code through Crockford\'s JSLint, and it gave the following error:\r\n\r\n__Problem at line 1 character 1: Missing \"use strict\" statement.__\r\n\r\nDoing some searching, I realized that some people add \"use strict\"; into their JavaScript code. Once I added the statement, the error stopped appearing. Unfortunately, Google did not reveal much of the history behind this string statement. Certainly it must have something to do with how the JavaScript is interpreted by the browser, but I have no idea what the effect would be.\r\n\r\nSo what is \"use strict\"; all about, what does it imply, and is it still relevant?\r\n\r\nDo any of the current browsers respond to the \"use strict\"; string or is it for future use?', '', 50, '2021-04-11', 0x31),
(5, 'hatq', 'How to limit the length of text in a paragraph [duplicate]', 'below is the code which populates description in my website:\r\ncurrently description goes to any no. of line based on product, i need to limit this to 3 lines.', '', 3, '2021-05-05', 0x30),
(6, 'hatq', 'How to define the correct interface and loop over the data in React?', 'I am kinda new to Typescript. Here I have a simple API, and I want to iterate through, and display the data. You can go to the Api link and see the raw data. I would be really grateful for some help', '', 2, '2021-05-05', 0x30),
(7, 'hatq', 'Map.get() in node js javascript always return undefined while fetching data from mongodb', 'I am using a map here in which I stored id:quantity pair I want to add this quantity to each item of products array (containing objects) and I am getting this quantity through map.get(id) method , despite the type of id and the id passed into get function are of same value and data type ,I am getting undefined, I tried to verify the type and value of id in map and id passed , both are same .still the problem exists', '', 3, '2021-05-05', 0x30),
(8, 'hatq', 'Multiple types of bulleted list in sublists in beamer', 'I tried to create a different bullets for sublists in beamer but everytime it creates the same bullet for nested lists as shown below. I tried label=\roman* but it is for enumitem. How do I change sublits bullets to something like arrow or rectangle?', '', 1, '2021-05-05', 0x31),
(9, 'hatq', 'How to install the windscribe vpn in ubuntu?', 'I have installed the ubuntu and now I want to install the windscribe vpn in ubuntu20\r\nPlease let me know the steps for doing that', '', 3, '2021-05-05', 0x30),
(10, 'hatq', 'How to disable transparent background of electron app?', 'I created a electron app. When the app starts, a login window opens with transparent background. I want that when user logged in successfully. Window\'s transparent property should be disabled. I didn\'t find any method like win.tranparent(false). How can I disable the transparent background', '', 0, '2021-04-11', 0x31),
(11, 'hatq', 'Sum two number using delimiter', 'If im given an input like 1:2 then the output should be 3. Likewise 54:6 then 60. But im getting an error stating that Exception in thread \"main\" java.lang.ArrayIndexOutOfBoundsException: Index 0 out of bounds for length 0at Hello.main(Hello.java:9)', '', 0, '2021-02-11', 0x31),
(12, 'hatq', 'PyQt4 signal To PyQT5?', 'I am not able to convert the following code from PyQt4 to PyQt5?', '', 0, '2021-03-10', 0x30),
(13, 'hatq', 'Binary Data in MySQL [closed]', 'How do I store binary data in MySQL?', '', 3, '2021-05-05', 0x31),
...
('tronghaiit2', 1, 'Alo', 0, '2021-04-21', 24, 0),
